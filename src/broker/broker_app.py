"""
broker_app.py – Standalone Message Broker
==========================================
Samostatná FastAPI aplikace pro message broker.
Zodpovědnosti:
  - WebSocket /broker endpoint (subscribe, publish, ack, pending delivery)
  - Persistence zpráv přes QueuedMessage model
  - Broadcast zpráv všem subscriberům daného topicu

Spouštění:
    PYTHONPATH=src python src/broker/broker_app.py
    PYTHONPATH=src python src/broker/broker_app.py --host 0.0.0.0 --port 8082
"""
